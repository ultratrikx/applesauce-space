  ...
  return (
    <div className="flex overflow-hidden flex-col ml-3 bg-white rounded-sm border border-solid border-white border-opacity-10 max-md:max-w-full">
      <div className="flex relative flex-col w-full min-h-[1080px] max-md:max-w-full">
        {/* <Image
          src="https://cdn.builder.io/api/v1/image/assets/TEMP/e30d09288efa5a23879d875bfd934c20cedcd6e556d49ebdd29a7dbe887dc07d?placeholderIfAbsent=true&apiKey=5b8e72dd7c7f47caad1dc05862aaf1eb"
          alt="Background"
          layout="fill"
          objectFit="cover"
          priority
        ...
        <div className="flex relative flex-col items-center px-16 pt-2 w-full min-h-[1080px] pb-[713px] max-md:px-5 max-md:pb-24 max-md:max-w-full">
          {/* <Image
            src="https://cdn.builder.io/api/v1/image/assets/TEMP/94e1adc55f2d503f08ce18f3ac97f3323924289b156d0053e7c593c3ea8715a2?placeholderIfAbsent=true&apiKey=5b8e72dd7c7f47caad1dc05862aaf1eb"
            alt="Overlay"
            layout="fill"
            objectFit="cover"
          /> */}
              ...
              <div className="flex flex-col w-[67%] max-md:ml-0 max-md:w-full">
                <div className="flex relative flex-col grow mt-3 max-md:mt-10 max-md:max-w-full">
                  ...
                  <div className="mt-6 text-3xl font-medium leading-10 text-black max-md:max-w-full">
                    Satellites are hard to keep track of, who knows when they pass by.
                    ...
                    You can view the various bands of data, whether it&apos;s NDVI, water
